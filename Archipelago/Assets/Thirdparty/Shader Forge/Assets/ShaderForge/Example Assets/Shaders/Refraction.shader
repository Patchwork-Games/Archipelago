...
Shader "Shader Forge/Examples/Refraction" {
    Properties {
        ...
        _node_9402 ("node_9402", Color) = (0.2126647,0.6853529,0.764151,1)
        _node_7824 ("node_7824", 2D) = "white" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float4, _node_9402)
...
////// Specular:
                ...
                float4 _node_9402_var = UNITY_ACCESS_INSTANCED_PROP( Props, _node_9402 );
                float3 diffuseColor = _node_9402_var.rgb; // Need this for specular when using metallic
