...
public class @InputMaster : IInputActionCollection, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""QuickRight"",
                    ""type"": ""Button"",
                    ""id"": ""39abac97-ebf2-439d-ad5d-07326f360c07"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
                ...
                },
                {
                    ""name"": ""Upright"",
                    ""type"": ""Button"",
                    ""id"": ""039fdb43-7732-43e9-9727-e41c0dba9372"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""d5ef388d-a7f1-414f-bae1-c81f91e3d2cc"",
                    ""path"": ""<XInputController>/rightShoulder"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""GamePad"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9772509f-4b6b-4124-867f-af245b345485"",
                    ""path"": ""<XInputController>/leftShoulder"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""GamePad"",
                ...
                {
                    ""name"": """",
                    ""id"": ""781db81c-d56d-4291-a0b7-28003d607ddf"",
                    ""path"": ""<Gamepad>/select"",
                    ""interactions"": ""Press"",
                    ""processors"": """",
                    ""groups"": ""GamePad"",
                ...
                {
                    ""name"": """",
                    ""id"": ""6abc3d73-243e-484b-b02f-412b320ec09b"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": ""Press"",
                    ""processors"": """",
                    ""groups"": ""Keyboard and Mouse"",
    ...
    ""controlSchemes"": [
        ...
        m_Boat_Upright = m_Boat.FindAction("Upright", throwIfNotFound: true);
        // MusicKeys
    ...
    private readonly InputAction m_Boat_Upright;
    public struct BoatActions
    {
        ...
        public InputAction @Upright => m_Wrapper.m_Boat_Upright;
        ...
        public void SetCallbacks(IBoatActions instance)
        {
            if (m_Wrapper.m_BoatActionsCallbackInterface != null)
            {
                ...
                @QuickRight.started -= m_Wrapper.m_BoatActionsCallbackInterface.OnQuickRight;
                @QuickRight.performed -= m_Wrapper.m_BoatActionsCallbackInterface.OnQuickRight;
                @QuickRight.canceled -= m_Wrapper.m_BoatActionsCallbackInterface.OnQuickRight;
                ...
                @Upright.started -= m_Wrapper.m_BoatActionsCallbackInterface.OnUpright;
                @Upright.performed -= m_Wrapper.m_BoatActionsCallbackInterface.OnUpright;
                @Upright.canceled -= m_Wrapper.m_BoatActionsCallbackInterface.OnUpright;
            }
            ...
            if (instance != null)
            {
                ...
                @CameraMovement.performed += instance.OnCameraMovement;
                @CameraMovement.canceled += instance.OnCameraMovement;
                @QuickRight.started += instance.OnQuickRight;
                @QuickRight.performed += instance.OnQuickRight;
                @QuickRight.canceled += instance.OnQuickRight;
