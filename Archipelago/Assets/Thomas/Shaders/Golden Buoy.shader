...
Shader "Shader Forge/Glow" {
    Properties {
        ...
        _NormalIntesity ("NormalIntesity", Range(0, 10)) = 8.803419
    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _NormalIntesity)
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float _NormalIntesity_var = UNITY_ACCESS_INSTANCED_PROP( Props, _NormalIntesity );
                float3 normalLocal = lerp(_NormalMap_var.rgb,float3(_NormalIntesity_var,_NormalIntesity_var,_NormalIntesity_var),float3(0,0,0));
