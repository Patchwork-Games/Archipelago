...
Shader "Shader Forge/GrassUnlit" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma target 3.0
            uniform sampler2D _node_8897; uniform float4 _node_8897_ST;
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += (o.vertexColor.r*float3(node_3699,0.0,node_3699));
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 _node_8897_var = tex2D(_node_8897,TRANSFORM_TEX(i.uv0, _node_8897));
                clip(_node_8897_var.a - 0.5);
////// Lighting:
////// Emissive:
                float3 emissive = _node_8897_var.rgb;
