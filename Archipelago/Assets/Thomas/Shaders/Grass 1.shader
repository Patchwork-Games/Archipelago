...
////// Specular:
                ...
                float3 diffuseColor = (_node_3992_var.rgb*_MainColour_var.rgb); // Need this for specular when using metallic
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,_node_3992_var.a);
...
/// Final Color:
                float3 finalColor = diffuse + specular;
                fixed4 finalRGBA = fixed4(finalColor * _node_3992_var.a,0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float4 _node_3992_var = tex2D(_node_3992,TRANSFORM_TEX(i.uv0, _node_3992));
                float4 _MainColour_var = UNITY_ACCESS_INSTANCED_PROP( Props, _MainColour );
                float3 diffColor = (_node_3992_var.rgb*_MainColour_var.rgb);
                float specularMonochrome;
                float3 specColor;
                float _Metal_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Metal );
