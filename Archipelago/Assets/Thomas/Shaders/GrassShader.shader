...
Shader "Shader Forge/GrassShader" {
    Properties {
        ...
        _Wind_Speed ("Wind_Speed", Range(0, 1)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_3836 = 0.0;
                v.vertex.xyz += (o.vertexColor.rgb*_WindTexture_var.rgb*_WindStrength_var*mul( unity_WorldToObject, float4(float3(node_795,node_3836,node_3836),0) ).xyz.rgb);
